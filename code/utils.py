...
'''
from utils import *
filelists=['0_attype0_true484_adv871_qf96.jpg', '1_attype0_true233_adv199_qf92.jpg', '3_attype3_true154_adv747_qf96.jpg']

ori_qf = []
down_qf = []
for filename in filelists:
    img_qf = int(jpeg_qtableinv('./Facebook/'+filename))
    in_qf = int(filename.split('_')[4].split("qf")[1].split('.')[0])
    ori_qf.append(in_qf)
    down_qf.append(img_qf)
